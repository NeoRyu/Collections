...
public class Main {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("\n"+charas);
		//tri alphabet
		CompareChildObject(charas);
		System.out.println("\n------------\n");
		System.out.println(charas);
		
	}	
	
	//APPEL : CompareChildObject(charas);
	public static void CompareChildObject(List<ChildObject> datas){
		Collections.sort(datas, new Comparator<ChildObject>() {
			@Override
